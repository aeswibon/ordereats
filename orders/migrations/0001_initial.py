    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selection_type', models.CharField(choices=[('must_select_one', 'Must Select One'), ('can_select_multiple_or_none', 'Can Select Multiple or None')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.AddField(
            ...
            name='product',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='option_lists', to='orders.product'),
        ),
        migrations.CreateModel(
            name='CartItem',
            fields=[
                ...
                ('selected_options', models.ManyToManyField(blank=True, to='orders.option')),
